...
#Frame per sec
#how quickly the game is running
FPS = 60

WIDTH, HEIGHT = 800, 800
ROWS = 4
COLS = 4
#height and width within the grid
...
def draw_grid(window):
    ...
    pygame.draw.rect(WINDOW, OUTLINE_COLOR, (0, 0, WIDTH, HEIGHT), OUTLINE_THICKNESS) #outline
...
#only exe when we run the file directly, otherwise will not be called
